...
export default function BagCheckRegular() {
    ...
    return (
        ...
        >
            <path fill="none" strokeLinecap="round" strokeLinejoin="round" strokeWidth={32} d="m320 264l-89.6 112l-38.4-44.88"></path>
