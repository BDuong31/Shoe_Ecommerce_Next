...
export default function DocumentTextRegular() {
    ...
    return (
        ...
        >
	        ...
	        <path fill="none" strokeLinecap="round" strokeLinejoin="round" strokeWidth={32} d="M256 56v120a32 32 0 0 0 32 32h120m-232 80h160m-160 80h160"></path>
        </svg>
    )
}

export function DocumentTextBold() {
    const { theme } = useTheme();
    return (
        <svg
            className="dark:stroke-[#F8F8F8] stroke-[#1F1F1F]"
