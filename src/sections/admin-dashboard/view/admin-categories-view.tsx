    ...
    <div className="flex flex-col gap-6 p-6 max-h-[90vh] overflow-y-auto scrollbar-hide">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          ...
          <p className="text-base-content/70 text-sm">Home &gt; Categories</p>
        </div>
      ...
      <dialog id="edit_modal" className="modal">
        <div className="modal-box w-11/12 max-w-lg">
          <h3 className="font-bold text-lg">Edit Category: {editingCategory?.name}</h3>
          <div className="py-4 space-y-4">
            <div className="form-control">
              <label className="label"><span className="label-text font-semibold">Category Name</span></label>
              <input 
          ...
          <div className="modal-action">
            <form method="dialog"><button className="btn" onClick={() => setEditingCategory(null)}>Cancel</button></form>
            <button className="btn btn-neutral" onClick={handleUpdate}>Save Changes</button>
          </div>
        </div>
        <form method="dialog" className="modal-backdrop"><button onClick={() => setEditingCategory(null)}>close</button></form>
      </dialog>
      ...
      <dialog id="delete_modal" className="modal">
        <div className="modal-box">
          ...
          <div className="modal-action">
            <form method="dialog"><button className="btn" onClick={() => setCategoryToDelete(null)}>Cancel</button></form>
            <button className="btn btn-error" onClick={handleConfirmDelete}>Delete</button>
          </div>
        </div>
        <form method="dialog" className="modal-backdrop"><button onClick={() => setCategoryToDelete(null)}>close</button></form>
      </dialog>
